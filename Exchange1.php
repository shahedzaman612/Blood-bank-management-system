...
<div id="full">
    <div id="inner_full">
        ...
        <div id="body">
            ...
            $un=$_SESSION['un'];
            ?>
       <h1>Exchanged Blood Donor List</h1><br>
      <center> <div id="from">
          <table>
              <tr>
                  ...
                  <td><center><font color="black"><b>Blood Taken</b></font></center></td>
                  <td><center><font color="black"><b>Blood Given</b></font></center></td>
                  <td><center><font color="black"><b>E-mail</b></font></center></td>
